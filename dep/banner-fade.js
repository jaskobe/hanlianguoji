        ...
        var sliderFun = {
            controlInit: function() {
                ...
                if (settings.arrowControl) {
                    var html = "";
                    html += '<span class="slider-control prev fa fa-angle-left"></span>';
                    html += '<span class="slider-control next fa fa-angle-right"></span>'
                    $slider.append(html);
                }
            ...
            sliderInit: function() {
                ...
                if (settings.sliderMode == 'slide') {
                    ...
                    $sliderWrap.children().width((sliderWidth/sliderCount)+'%');
                    //$sliderWrap.width((100 * sliderCount)+'%');
                    //$sliderWrap.children().width(100/sliderCount+'%');
                }else{
                    // mode 模式
            ...
            sliderPlay: function(index) {
                ...
                if (settings.sliderMode == "slide") {
                    ...
                    if (index > currentIndex) {
                        $sliderWrap.animate({
                            left: '-=' + Math.abs(index - currentIndex) * sliderWidth + '%'
